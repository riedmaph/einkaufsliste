...
SELECT cleanString(name), count(*),0 FROM crawled.article WHERE cleanString(name) <> '' GROUP BY cleanString(name);
...
SELECT a.title,a.name,a.brand,a.SIZE,a.packagesize,a.amount,a.unit,a.url,a.price,'crawler',a.id,cat.cats,s.shopname
